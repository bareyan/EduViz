...
class TranslationService:
    ...
    async def translate_script(
        ...
        doc_title = script.get("title", "Educational Video")
        if translated_script.get("title"):
            ...
            doc_title = translated_script["title"]
        ...
        print(f"[TranslationService] Translation complete")
...
TRANSLATIONS:"""
        ...
        try:
            ...
            if len(translated_items) == len(items):
                ...
                print(f"[TranslationService] Item count mismatch, falling back to individual translation")

...
Usage:
  python backend/test_highlight_crop_api.py
  python backend/test_highlight_crop_api.py --keep
  python backend/test_highlight_crop_api.py --no-api
"""
...
async def main() -> int:
    ...
    crop_path = checker.crop_highlight_box(scene, box, config, output_dir=output_dir)
    if not crop_path:
